...
import ExpandableProcessFlow from '../../ExpandableProcessFlow';
import OperationMenu, { ActionItem } from '../../OperationMenu';
import { IconSend, IconSettings, IconStorage } from '@arco-design/web-react/icon';

const BasicDemo: React.FC = () => {
  const modelTrainingSteps: any[] = [
    {
